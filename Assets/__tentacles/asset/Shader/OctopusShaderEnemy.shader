Shader "OctopusShaderEnemy" {
	Properties {
		...
		_Albedo1 ("Albedo Color", Vector) = (1,1,1,1)
		...
		_Emission1 ("Emission Texture", 2D) = "white" {}
		[TCP2UVScrolling] _Emission1_SC ("Emission Texture UV Scrolling", Vector) = (1,1,0,0)
		_Emission2 ("Emission Float", Float) = 1
